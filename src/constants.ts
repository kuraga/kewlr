...
export const supportSymbolIterator: any = typeof Symbol === 'function' && Symbol.iterator !== undefined;
export const symbolIterator: any = supportSymbolIterator ? Symbol.iterator : undefined;
...
export const iterator = supportSymbolIterator ? symbolIterator : false;
